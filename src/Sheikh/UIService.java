...
/**
 * Handles the user interface for interacting with the apartment reservation system.
 */
public class UIService {
    PersistenceService ps;
    /**
     * Constructor to initialize the UIService with a given PersistenceService.
     *
     * @param _ps The PersistenceService to use for data persistence.
     */
    ...
    /**
     * Adds persons to a reservation based on user input.
     *
     * @param resv The Reservation object to which persons will be added.
     */
    ...
    /**
     * Searches for reservations based on user input (surname).
     */
