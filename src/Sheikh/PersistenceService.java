package Sheikh;
/** A service class to handle persistence operations for the apartment reservation using a MySQL database.
 * @author sheikhishtiakahmed
 * @version 5th May 2020
 */
...
public class PersistenceService {
    ...
    /**
     * Retrieves a list of all reservations from the database, including associated persons.
     *
    ...
    /**
     * Retrieves a list of reservations based on the provided surname.
     *
     * @param surname The surname to search for in reservations.
     * @return ArrayList of Reservation objects matching the surname.
     */
    ...
    /**
     * Inserts a new reservation into the database, including associated persons.
     *
     * @param resv The Reservation object to be inserted.
     */
    ...
    /**
     * Closes database resources (result set, prepared statement, and connection).
     */
    private void close() {
        try {
            if (resultSet != null) {
